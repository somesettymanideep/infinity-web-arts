...
import serviceImage from "@/assets/service-ecommerce.jpg";
      ...
      <main className="pt-16">
        ...
        <section className="relative py-20 md:py-32 overflow-hidden">
          <div className="absolute inset-0">
            <img src={serviceImage} alt="E-Commerce Solutions" className="w-full h-full object-cover" />
          ...
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="rounded-2xl overflow-hidden shadow-large">
                <img src={serviceImage} alt="E-Commerce" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </section>
